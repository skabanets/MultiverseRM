  ...
  return (
    <>
      <div
        ...
        className="h-[340px] card bg-teal-400 text-base-200 shadow-lg cursor-pointer hover:shadow-[#66ff00] hover:bg-[#66ff00] hover:scale-105 ease-out transition-all duration-600"
      >
        <figure>
